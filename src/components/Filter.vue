  ...
  <section class="filter-section">
    <div class="container compact">
      ...
      <div class="filters">
          ...
          <div class="filters__item">
            ...
            <div class="checkboxes">
              ...
              <input
                ...
                v-model="checkedFlats"
              />
              <label for="3-k">3-rm</label>
              <input
                type="checkbox"
                id="4-k"
                value="4-room or more"
                v-model="checkedFlats"
              />
              <label for="4-k">4-rm+</label>
            </div>
          </div>
          <div class="filters__item">
            <p class="subtitle">Floor</p>
            <Slider
        ...
        <div class="filters__column md-hide" :class="extended && 'extended'">
          <div class="filters__item">
            <p class="subtitle">Price, million $</p>
            <Slider
      ...
      <div class="additional">
        ...
        <a class="additional__flats" href="#">963 apartments found</a>
      ...
      <div class="finder">
        <div class="list-flats">
          <FlatCard text="Discount up to 250,000 $" />
          <FlatCard text="With Finishing" color="#63A8BE" />
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      projects: ["Any", "Dawid Olko", "Dawid Olko", "Dawid Olko"],
      finish: [
        "Any",
        "No Finishing",
        "Rough Finishing",
      ...
      deadline: ["Any", "Within 1 year", "Within 2-3 years", "After 3 years"],
      sliderValue: {
        floor: [1, 16],
        area: [24, 160],
        price: [4.1, 12.1],
  ...
  methods: {
    ...
    clearValue(name) {
      switch (name) {
        case "projects":
          this.selected.projects = "Any";
          break;
        case "finish":
          this.selected.finish = "Any";
          break;
        case "checkedFlats":
          this.checkedFlats = [];
          break;
    ...
    getFilters() {
      ...
      if (this.selected.projects !== "Any")
        data.push({
          name: "projects",
          value: "Project: " + this.selected.projects,
        });
      if (this.selected.finish !== "Any")
        data.push({
          name: "finish",
          value: "Finishing: " + this.selected.finish,
        });
      if (this.checkedFlats.length > 0)
        data.push({
          name: "checkedFlats",
          value: "Apartments: " + this.checkedFlats.join(", "),
        });
      if (this.sliderValue.floor[0] !== 1 || this.sliderValue.floor[1] !== 16)
        data.push({
          name: "floor",
          value: "Floors: " + this.sliderValue.floor.join("-"),
        });
      if (this.sliderValue.area[0] !== 24 || this.sliderValue.area[1] !== 160)
        data.push({
          name: "area",
          value: "Area: " + this.sliderValue.area.join("-") + " m²",
        });
      if (this.selected.deadline !== "Any")
        data.push({
          name: "deadline",
          value: "Deadline: " + this.selected.deadline,
        });
      if (
        ...
        data.push({
          name: "price",
          value: "Price: " + this.sliderValue.price.join("-") + "M $",
        });
